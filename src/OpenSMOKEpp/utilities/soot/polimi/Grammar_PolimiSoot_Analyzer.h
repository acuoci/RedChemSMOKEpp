...
namespace OpenSMOKE
{
	...
	protected:
		...
		virtual void DefineRules()
		{
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@SootMinimumSectionSphericalParticles",
				OpenSMOKE::SINGLE_INT,
				"Index of minimum discrete section which is considered a soot spherical particle (default: 5)",
				false));

			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@SootMinimumSectionAggregates",
				OpenSMOKE::SINGLE_INT,
				"Index of minimum discrete section which is considered a soot aggregate (default: 13)",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@PhysicalDiffusionBinToStart",
				OpenSMOKE::SINGLE_INT,
				"Physical diffusion reduction coefficient: BIN index where to start (default: 5)",
				false));

			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@PhysicalDiffusionBinToCut",
				OpenSMOKE::SINGLE_INT,
				"Physical diffusion reduction coefficient: BIN index where to cut (default: 10)",
				false));

			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@PhysicalDiffusionExp",
				OpenSMOKE::SINGLE_DOUBLE,
				"Physical diffusion reduction coefficient: exponent (default: -0.640)",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@ThermophoreticEffectMinimumBin",
				OpenSMOKE::SINGLE_INT,
				"Minimum BIN from which to apply the thermophoretic effect (default: 5)",
				false));

			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@ThermophoreticEffectAmplificationFactor",
				OpenSMOKE::SINGLE_DOUBLE,
				"Thermophoretic effect amplification factor",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@PlanckCoefficient",
				OpenSMOKE::SINGLE_STRING,
				"Calculation of Planck Coefficient: Smooke (default) | Kent | Sazhin | Hubbard | none",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@FormationRatesByClasses",
				OpenSMOKE::SINGLE_BOOL,
				"Soot formation rates based on classes (if any)",
				false));

			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@ClassCorrectionCoefficients",
				OpenSMOKE::VECTOR_STRING,
				"Correction coefficient (multiplier) of frequency factors of soot classes (if any)",
				false));
		}
	};
}
