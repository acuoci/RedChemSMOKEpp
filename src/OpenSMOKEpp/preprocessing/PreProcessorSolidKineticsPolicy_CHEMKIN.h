...
namespace OpenSMOKE
{
	//!  Class to pre-process a kinetic mechanism provided in CHEMKIN format
	/*!
		 This class pre-process a kinetic mechanism in CHEMKIN format (ASCII format).
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		*@brief This function returns the vector containing the list of reactions
		...
		*/
		...
		/**
		*@brief This function returns the vector containing the list of site species
		...
		*/
		...
		/**
		*@brief This function returns the vector containing the list of all the additional species 
		*@return the vector containing the list of site species
		*/
		...
		* Reads only the list of species and elements from the file containing the kinetic
		  mechanism in CHEMKIN format. This operation is needed to correctly pre-process the
	...
	protected:
		...
		std::vector<std::string>				names_solid_species_;		//!< vector of solid species indices
		...
		*/			
		...
		/**
		* Writes the reaction orders in a format which can be used by the KineticsMap_CHEMKIN (only if the
