...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*/
		const std::vector<double>& species_max_tau() const { return species_max_tau_; }

		/**
		*@brief Returns the idt (in s) based on the maximum species mole fraction slope
		*/
		const std::vector<double>& species_slope_tau() const { return species_slope_max_tau_; }

		/**
		*@brief Returns the species indices for the evaluation of idt
		*/
		const std::vector<unsigned int>& species_index() const { return species_index_; }

		/**
		*@brief Returns the idt (in s) based on the target of the absolute molefraction of species
		*/
		const std::vector<double>& species_target_abs_tau() const { return species_target_abs_tau_; }

		/**
		*@brief Returns the idt (in s) based on the target of the relative molefraction of species
		*/
		const std::vector<double>& species_target_rel_tau() const { return species_target_rel_tau_; }

		/**
		*@brief Returns the idt (in s) based on the target of the absolute concentration of species
		*/
		const std::vector<double>& species_target_c_tau() const { return species_target_c_tau_; }

		/**
		*@brief Returns the idt (in s) based on the minimum incerception of species
		*/

		const std::vector<double>& species_intercept_min_tau() const { return species_intercept_min_tau_; }

		/**
		*@brief Returns the idt (in s) based on the maximum incerception of species
		*/
		const std::vector<double>& species_intercept_max_tau() const { return species_intercept_max_tau_; }
