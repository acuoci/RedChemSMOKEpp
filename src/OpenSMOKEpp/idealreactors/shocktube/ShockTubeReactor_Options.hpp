...
namespace OpenSMOKE
{
	class Grammar_ShockTubeReactor_Options : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
	...
	ShockTubeReactor_Options::ShockTubeReactor_Options()
	{
	...
	void ShockTubeReactor_Options::SetupFromDictionary(OpenSMOKE::OpenSMOKE_Dictionary& dictionary)
	{
		Grammar_ShockTubeReactor_Options grammar;
