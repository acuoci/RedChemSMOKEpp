...
#ifndef OpenSMOKE_BatchReactor_Options_H
#define	OpenSMOKE_BatchReactor_Options_H
...
namespace OpenSMOKE
{
	...
	public:
		...
		*/
		...
		/**
		*@brief Returns the ASCII precision
		*/
		int ascii_precision() const { return ascii_precision_; }
	...
	private:
		...
		int ascii_precision_;								//!< number of significant digits for ASCII output
...
#include "BatchReactor_Options.hpp"

#endif	/* OpenSMOKE_BatchReactor_Options_H */
