	...
	*/
	...
	public:
		...
		*/
		...
		/**
		*@brief Set the environment temperature profile
		*@param profile the environment temperature profile
		*/		
		void SetEnvironmentTemperatureProfile(OpenSMOKE::PlugFlowReactor_Profile&  profile);

		/**
		*@brief Set a global thermal exchange coefficient profile
		*@param profile the global thermal exchange coefficient profile
		*/
		void SetGlobalThermalExchangeCoefficientProfile(OpenSMOKE::PlugFlowReactor_Profile& profile);
	...
	protected:
		...
		bool is_environment_temperature_profile_;								//!< true if environment temperature profile is available
		OpenSMOKE::PlugFlowReactor_Profile* environment_temperature_profile_;	//!< environment temperature profile

		bool is_global_thermal_exchange_coefficient_profile_;								//!< true if global thermal exchange coefficient profile is available
		OpenSMOKE::PlugFlowReactor_Profile* global_thermal_exchange_coefficient_profile_;	//!< global thermal exchange coefficient profile is available
	};
}
