	...
	*/
	...
	protected:
		...
		*/
		...
		/**
		*@brief Pressure gradient due to friction with walls
		*@return the spatial pressure gradient (Pa/m)
		*/
...
protected:
		...
		double environment_temperature_;						//!< environment temperature  			
		...
		double dP_over_dcsi_;						//!< pressure gradient [Pa/m]
		double csi_old_;							//!< spatial coordinate at the previous step [m]
		double P_old_;								//!< pressure at the previous step [Pa]
